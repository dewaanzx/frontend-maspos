<template>
	<h1 class="font-semibold text-lg">Register Page</h1>
	<form action="" @submit.prevent="register">
	  ...
	  <div class="mb-6">
		  ...
		  <input v-model="formData.username" type="text" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="John Doe" required>
	  </div>
	  <div class="mb-6">
